...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-4inobei.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-4inobei.containers.anotherwebservice.com/
...
```
git clone git@github.com:Shazzum1/container-4inobei.git
cd container-4inobei
```
...
```
docker attach container-4inobei
```
